...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let split = self.splitViewController {
            ...
            let topNavigationController = controllers[controllers.count-1] as? UINavigationController
            self.detailViewController = topNavigationController!.topViewController as? DetailViewController
        }
